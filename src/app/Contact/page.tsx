...
const Contact = () => {
  ...
  function sendEmail(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (formRef.current) {
      ...
      setIsLoading(true);
      emailjs
        .send("service_k3q16ks", "template_911xikj", data, "RTG4YzTeFbZa0ufOf")
        .then(
          (response) => {
    ...
    <div className=" dark:bg-gray-800 h-screen space-y-6">
      <div className="relative  dark:bg-gray-800 ">
        <img
          ...
          className="w-full h-80 lg:h-[30rem]"
          // className="className='w-full h-[30rem] sm:h-[40rem] md:h-[50rem] lg:h-[40rem] dark:bg-gray-700 dark:text-white"
          alt="image"
        />
      </div>
        ...
        <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
          <div className="mt-8 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <form
                className="p-6 flex flex-col justify-center dark:text-white"
                ref={formRef}
                onSubmit={sendEmail}
              >
                <div className="flex flex-col ">
                  ...
                  <input
                    ...
                    className="w-100 mt-2 py-3 px-3 rounded-lg dark:text-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="md:w-32 bg-indigo-500  dark:text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-900 transition ease-in-out duration-300"
                >
                  Submit
                </button>
              </form>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            <div className="flex items-center justify-center">
              ...
              <p className="ml-4 text-gray-900 dark:text-white">Loading...</p>
            </div>
          </div>
        </div>
      )}
